 ...
 */
export function CsOutcomeSection({ blocks, stripImages = [] }: Props) {
        ...
        <section className="bg-white w-full">
            ...
            {stripImages.length > 0 && (
                <div className="w-full overflow-hidden bg-[#f0f4fa] py-0 border-y border-[#dde4ee]">
                    {stripImages.length === 1 ? (
                        ...
                        <div className="flex gap-4 px-4 overflow-x-auto scrollbar-none snap-x py-6">
            ...
            {growthBlock && (
                <div className="max-w-[1062px] mx-auto px-5 md:px-10 py-4 pb-16">
                    <div className="grid grid-cols-1 md:grid-cols-[301.76px_1fr] gap-x-6 gap-y-3 py-6 md:py-8">
                        <div className="font-['Stack_Sans_Text:SemiBold'] font-semibold leading-tight pt-[2px] text-[#3e0078] text-[18px] md:text-[20px] tracking-[0.08em] uppercase">
