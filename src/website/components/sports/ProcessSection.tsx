          ...
          {spSteps.map((s, i) => (
            <div key={s.badge} className="flex w-[280px] sm:w-[320px] md:w-full shrink-0 snap-start">
              ...
              >
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[170px] h-[1px] bg-gradient-to-r from-transparent via-[#1ff9b8]/35 to-transparent z-10" />
                ...
                {/* Step-specific Transparent Green-Glowing Icon */}
                <div className="w-[44px] h-[44px] rounded-full bg-gradient-to-b from-[#1ff9b8]/15 to-white/[0.03] shadow-[0_4px_24px_rgba(31,249,184,0.25)] flex items-center justify-center border border-white/10 shrink-0">
                  {i === 0 && (
                    <svg className="w-5 h-5 text-[#1ff9b8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                ...
                <div className="mt-6 flex flex-col gap-1">
                  <span className="text-[#1ff9b8] font-body font-medium text-[13px] md:text-[16px] tracking-[-0.2px]">{s.badge}</span>
