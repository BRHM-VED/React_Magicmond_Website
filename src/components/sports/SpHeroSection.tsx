...
export function SpHeroSection() {
  return (
    <section className="sp-hero">
      <img className="sp-hero__bg" src="/assets/images/common/o8Jqke0y2Ge0u7Bolq0usRyapLE.png" alt="" />
      ...
      <div className="sp-hero__content">
        ...
        <img className="sp-hero__stadium reveal" style={{ '--d': '.4s' } as React.CSSProperties} src="/assets/images/sports/xujDrco0fopCHTrPON20PgyPnoo.png" alt="Cricket stadium" />
      </div>
    </section>
  );
}
export default SpHeroSection;
