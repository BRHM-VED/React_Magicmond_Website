...
function OfferCard() {
  return (
    <div className="ie-offer__visual reveal-scale">
      ...
      <img src="/assets/images/infraedge/EsupTI2qEGUll4EL8eb3QL996g.png" alt="Handshake" />
    </div>
  );
}
...
export function IeOfferSection({ end }: OfferSectionProps) {
  return (
