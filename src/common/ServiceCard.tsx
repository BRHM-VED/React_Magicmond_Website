...
export function ServiceCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-[calc(100%+3rem)] -mx-6 mb-[-2.25rem] md:w-[345px] h-[250px] md:h-[309px] shrink-0 self-stretch md:self-auto rounded-t-none rounded-b-[19px] md:rounded-[28px] md:rounded-t-[28px] md:rounded-b-[28px] md:mx-0 md:mb-0 overflow-hidden">
